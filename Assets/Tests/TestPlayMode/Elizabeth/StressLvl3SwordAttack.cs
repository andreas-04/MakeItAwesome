...
//public class ElizabethS_SwordAttackSpamTest
//{
...
//        playerAttack.ChangeWeapon(new SwordAttack(), SwordAttack);
...
//        Debug.Log($"Current Animator State: {currentAnimatorState.IsName("Player_Sword")}");

//        // Assert that the animation is playing
//        Assert.IsTrue(currentAnimatorState.IsName("Player_Sword"), "Stick Attack animation is not playing.");
//    }
//}
